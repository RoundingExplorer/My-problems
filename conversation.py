...
def command(self, line, game, cmd ,trap):
	if cmd == "commands" or cmd == "help":
		self.send_reply(line, "Supported commands: !name, !jokes , !hello ,!goodbye !howto, !eval, !queue, !trap")
	elif cmd == "wait" and game.is_abortable():
		game.ping(60, 120)
		self.send_reply(line, "Waiting 60 seconds...")
	elif cmd == "jokes":
		self.send_reply(line, "No one can go out!No one: Ok bye then")
	elif cmd == "hello":
		self.send_reply(line, "Hello,dude!")
	elif cmd == "goodbye":
		self.send_reply(line, "Goodbye!Have a nice day ;)")
	elif cmd == "name":
